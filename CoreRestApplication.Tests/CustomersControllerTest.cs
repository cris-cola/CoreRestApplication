...
namespace CoreRestApplication.Tests
{
    public class CustomersControllerTest
    {
        ...
        private static List<CustomerModel> MockRepositoryResponse()
        {
            ...
            {
                new MrGreenCustomerModel(1, "Winston", "Churchill", new AddressModel("Downey St.", "222", "60766"), "(222) 555-1212"){CustomerType = "GreenHat"},
                new RedBetCustomerModel(2, "Bon", "Jovi", new AddressModel("1234 St. Francisco", "122", "12345"), "Barcelona"){CustomerType = "MrBet"}
            };
        }
